...
Se si cercano note con tag “tag1” utilizzando la query “t.tag1”, questa nota sarà inclusa nei risultati di ricerca.

*** La nota con il tag =ARCHIVE= impostato è colorata in grigio:ARCHIVE:

** La nota può avere uno stato

È possibile configurare qualsiasi numero di stati da usare: TODO, NEXT, DONE, ecc.

*** TODO Ci sono due /tipi/ di stati: todo e done

*** DONE Questa è una nota con il tipo di stato /done/
CLOSED: [2018-01-24 Mer 17:00]

** Le note gerarchicamente superiori possono tracciare lo stato di quelle sotto di loro [1/3] [33%]

*** TODO Per tenere traccia del rapporto TODO/ DONE aggiungere [/] al titolo della nota

*** TODO Per avere il rapporto DONE/TODO in percentuale, aggiungere [%] al titolo della nota

*** DONE Possono essere usate entrambe in tandem
CLOSED: [2025-03-13 Thu 08:37]

Non importa l'ordine e i conteggi verranno aggiornati automaticamente .
...
Contrassegna la nota come conclusa (DONE) per spostarne la ripetizione.
...
** Sono supportate le formattazioni di base

Puoi usare parole in *grassetto*, /corsivo/, _sottolineato_, =scandito=, ~tipo codice~ e +barrato+.

** È disponibile una lista di spunte

- [X] Attività 1
- [ ] Attività 2
- [ ] Attività 3

Fare clic sulla casella per cambiarne lo stato. Premere il pulsante nuova riga alla fine della linea per creare un nuovo elemento.

** Il titolo della nota può anche contenere lo stato di avanzamento  [66%] [2/3]
...
Le note possono essere cercate per stato, per tag, per  programmazione o per scadenza ecc.
...
Prova a fare ricerche semplici dal cassetto di navigazione e annota quali stringhe usino.

Puoi creare le tue ricerche salvate premendo su "Ricerche" nel menu di navigazione.
